...
const PersonIcon = ({ className }: IconType) => {
  return (
    <svg className={className ? `${className}` : ""} stroke='currentColor' fill='currentColor' strokeWidth='0' viewBox='0 0 16 16' xmlns='http://www.w3.org/2000/svg'>
